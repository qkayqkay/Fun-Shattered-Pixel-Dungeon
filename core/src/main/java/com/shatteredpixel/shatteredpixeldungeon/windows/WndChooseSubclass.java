...
public class WndChooseSubclass extends Window {
	...
	public WndChooseSubclass(Blindweed.Seed seed, Hero hero){ // I CANT BE FUCKKKKEEEDDDD

		super();

		IconTitle titlebar = new IconTitle();
		titlebar.icon( new ItemSprite(ItemSpriteSheet.SEED_BLINDWEED, null ) );
		titlebar.label( seed.name() );
		titlebar.setRect( 0, 0, WIDTH-16, 0 );
		add( titlebar );
