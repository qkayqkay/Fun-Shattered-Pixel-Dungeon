...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.ArthropodsBane;
...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.RGB;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public static abstract class Enchantment implements Bundlable {
		...
		public static final Class<?>[] common = new Class<?>[]{
				Blazing.class, Chilling.class, Kinetic.class, Shocking.class, ArthropodsBane.class};
		...
		public static final Class<?>[] rare = new Class<?>[]{
				Corrupting.class, Grim.class, Vampiric.class, RGB.class};
