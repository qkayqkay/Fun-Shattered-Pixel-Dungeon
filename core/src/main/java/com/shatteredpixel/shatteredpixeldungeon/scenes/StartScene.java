		...
		public void set( int slot ){
			...
			if (newGame){
				...
				if (hero == null){
					...
					hero = new Image(info.heroClass.spritesheet(), 0, 15*armorTier, 12, 15);
					add(hero);
					...
					hero.copy(new Image(info.heroClass.spritesheet(), 0, 15*armorTier, 12, 15));
